...
enum ImGuiTooltipFlags_
{
    ...
    ImGuiTooltipFlags_OverridePrevious          = 1 << 1,   // ClearBuffer/ignore previously submitted tooltip (defaults to append)
};
...
struct ImGuiSettingsHandler
{
    ...
    void        (*ClearAllFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler);                                // ClearBuffer all settings data
