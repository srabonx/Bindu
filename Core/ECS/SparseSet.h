...
namespace BINDU
{
	...
	public:
		...
		Component&	Add(EntityId entity,const Component& component)
		{
			...
			BINDU_ASSERT(m_sparsePool[entity] == InvalidIndex, "Entity already has the component!");
		...
		{
			BINDU_ASSERT(entity < m_sparsePool.size(), "Entity out of range!");

			auto denseIndex = m_sparsePool[entity];

			BINDU_ASSERT(denseIndex != InvalidIndex, "Entity doesn't have the component!");
		...
		{
			BINDU_ASSERT(Has(entity), "Entity doesn't have the component!");
