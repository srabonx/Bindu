...
namespace BINDU
{
	DirectXConstantBuffer::DirectXConstantBuffer(std::uint32_t elementCount, std::uint32_t elementByteSize) : m_elementCount(elementCount)
	{
		m_elementByteSize = D3DUtility::CalculateConstantBufferByteSize(elementByteSize);
	}
